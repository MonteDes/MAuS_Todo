...
public class TodoItem implements Serializable {
    ...
    private ArrayList<Long> associatedContacts;
    ...
    public TodoItem(String name, String description, boolean important, long dueDate, boolean done, ArrayList<Long> associatedContacts){
    ...
    public ArrayList<Long> getAssociatedContacts() {
        return associatedContacts;
    }

    public void setAssociatedContacts(ArrayList<Long> associatedContacts) {
        this.associatedContacts = associatedContacts;
    }

    public void addAssociatedContact(long id) {
        this.associatedContacts.add(id);
    }
